  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        glass: "bg-card/50 backdrop-blur-xl border-border/50 text-foreground",
        positive: "border-transparent bg-success/15 text-success",
        ...
        hero: "border-transparent bg-gradient-to-r from-primary to-accent text-primary-foreground shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
